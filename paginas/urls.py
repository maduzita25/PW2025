...
from .views import (
    ...
    CampusCreate, CategoriaCreate,  SugestaoCreate, ComentarioCreate, CursoCreate, TipoSolicitacaoCreate,
    CampusUpdate, CategoriaUpdate , SugestaoUpdate, ComentarioUpdate, CursoUpdate, TipoSolicitacaoUpdate,
)
